...
| **Windscribe**           | Official Website (`.deb`)                                                          | VPN Service                           |
...
| **Tiling Shell**                             | Provides an advanced tiling window management system.             |
| **Status Area Horizontal Spacing**           | Allows customizing the gap between icons in the top bar.          |
| **Tiling Assistant**                         | Adds Windows-like snap assist and advanced tiling layouts.        |
...
On **Fedora**, to make "open in Tilix" appear in Nautilus:
