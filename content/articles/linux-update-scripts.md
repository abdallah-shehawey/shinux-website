...
description: >-
  update-every-thing: one script for both apt and dnf that updates the system,
  Flatpak, Snap, firmware and GNOME extensions — retrying a failing step a fixed
  number of times, then moving on and reporting what happened.
