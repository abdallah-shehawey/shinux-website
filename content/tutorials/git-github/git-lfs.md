...
description: >-
  Welcome to the Git LFS guide! If you already know the basics of Git and GitHub,
  you are fully ready to learn this tool. This file is designed to be your permanent,
  comprehensive reference for understanding and managing large files in your repositories.
order: 7
tags:
  - git
  - github
...
- **Windows:** Download the installer from the [Git LFS website](https://git-lfs.github.com/) or install via winget: `winget install GitHub.GitLFS`
