...
## `executer.c` Exec in Isolation, No Fork at All
...
## `femtoshell.c` a Loop with No Fork at All
...
## `simple_shell.c` Fork, Execve, and Wait, the Whole Loop Closed
...
## `pico_shell.c` Path Search, Real Builtins, Robust Status Handling
...
## `nano_shell.c` Shell Variables and `export`
