...
## 2. The point: `free()` usually doesn't shrink the heap back
...
## 3. Checking a running process's actual memory map
...
## 4. ASLR gets in the way of predicting addresses
...
## 5. A note on this specific copy of the file
