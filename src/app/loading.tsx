    ...
    <div className="mx-auto w-full animate-pulse px-4 pt-6 pb-12 sm:px-8 lg:px-12">
      ...
      <section className="pb-12 text-center sm:text-start">
        ...
        <div className="mx-auto mb-8 max-w-xl font-mono text-sm sm:mx-0">
          <div className="flex items-center gap-1.5">
            <div className="h-4 w-3 rounded skeleton-bar" />
            <div className="h-4 w-16 rounded skeleton-bar" />
          </div>
          <div className="mt-1 h-4 w-96 max-w-full rounded skeleton-bar" />
          
          <div className="mt-3 flex items-center gap-1.5">
            <div className="h-4 w-3 rounded skeleton-bar" />
            <div className="h-4 w-44 rounded skeleton-bar" />
          </div>
          <div className="mt-1 h-4 w-80 max-w-full rounded skeleton-bar" />
        </div>

        {/* Title & Description */}
        <div className="h-10 w-96 max-w-full rounded skeleton-bar" />
        <div className="mt-4 flex flex-col gap-2">
          <div className="h-5 w-[500px] max-w-full rounded skeleton-bar" />
          <div className="h-5 w-96 max-w-full rounded skeleton-bar" />
        </div>
      ...
      <section className="pb-10">
        <div className="mb-4 flex items-baseline justify-between">
          <div className="h-6 w-32 rounded skeleton-bar" />
      ...
      <section className="pb-20">
        <div className="mb-4 flex items-baseline justify-between">
          <div className="h-6 w-52 rounded skeleton-bar" />
          <div className="h-4 w-32 rounded skeleton-bar" />
        </div>
        <div className="grid auto-rows-fr gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="flex flex-col gap-2 rounded-xl border border-border bg-card p-5">
