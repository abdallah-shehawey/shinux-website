// Skeleton that mirrors the real TutorialReader layout with sticky subheader:
// sticky back-bar + 3-column grid [Lessons sidebar | Content | TOC sidebar] — no layout shift.
