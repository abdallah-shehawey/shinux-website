...
// Statically prerendered — see the note in src/app/articles/page.tsx. Search
// and the admin check moved into TutorialsBrowser so this route never reads
// `searchParams` or cookies(), either of which would make every Tutorials tab
// click a server render.
export default async function TutorialsPage() {
  ...
  return (
    <div className="mx-auto w-full px-4 pt-6 pb-12 sm:px-8 lg:px-12">
      ...
      <TutorialsBrowser tracks={tracks} authors={authors} />
