...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      title="Toggle theme"
      className="inline-flex h-10 w-10 sm:h-9 sm:w-9 items-center justify-center rounded-lg border border-border text-muted transition hover:text-fg hover:border-accent active:scale-90"
    >
